...
//          try {
//            while (result.next()) {
//                // Access columns by column name or column index
//                String ingredient = result.getString("ingredient");
//                String qty_sod = result.getString("qty_sod");
//                String total_qty_sold = result.getString("total_qty_sold");
//                String percentage_diff = result.getString("percentage_diff");
//                // Do something with the retrieved data
//                System.out.println("Ingredient: " + ingredient + ", qty_sod: " + qty_sod + ", total_qty_sold: " + total_qty_sold + ", percentage_diff: " + percentage_diff);
//            }
